    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main id="main-content" className="flex-1">
        <article className="mx-auto max-w-4xl px-5 py-16 sm:py-24">
          ...
          <BreadcrumbJsonLd items={[{ name: "EleViewer", url: "https://eleviewer.vercel.app/" }, { name: "Alternatives", url: "https://eleviewer.vercel.app/alternatives" }, { name: "Adobe Reader alternative", url: "https://eleviewer.vercel.app/alternatives/adobe-reader" }]} />
