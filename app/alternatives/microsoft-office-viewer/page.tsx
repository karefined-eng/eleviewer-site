...
const rows = [
  ["DOCX files", "Yes", "Word Viewer discontinued"],
  ["XLSX files", "Yes", "Excel Viewer discontinued"],
  ["PPTX files", "Yes", "PowerPoint Viewer discontinued"],
  ["Portable .exe", "Yes", "No"],
  ["Admin rights", "Not required", "Varies by setup"],
        ...
        <article className="mx-auto max-w-4xl px-5 py-16 sm:py-24">
          ...
          <BreadcrumbJsonLd
            items={[
              ...
              {
                name: "Microsoft Office Viewer alternative",
                url: "https://eleviewer.vercel.app/alternatives/microsoft-office-viewer",
              },
            ]}
          />
          ...
          <h1 className="mt-5 max-w-3xl text-balance text-3xl font-bold tracking-tight sm:text-5xl">
            A free alternative to Microsoft Office Viewer
          </h1>
          <p className="mt-5 max-w-2xl text-pretty text-base leading-7 text-muted-foreground">
            Microsoft Word Viewer, Excel Viewer, and PowerPoint Viewer were discontinued. EleViewer gives Windows users one portable app for opening common Office files without buying or installing Microsoft Office.
          </p>
          <div className="mt-10 overflow-x-auto rounded-xl border border-border">
            <table className="w-full min-w-[520px] text-left text-sm">
              <caption className="sr-only">
                EleViewer compared with discontinued Microsoft viewers
              </caption>
              <thead className="bg-panel text-muted-foreground">
                <tr>
                  ...
                  <th className="p-4 font-medium">Old Microsoft viewers</th>
                </tr>
              </thead>
              <tbody>
                {rows.map(([feature, eleviewer, microsoft]) => (
                  <tr key={feature} className="border-t border-border">
                    <th className="p-4 font-medium">{feature}</th>
                    <td className="p-4 text-muted-foreground">{eleviewer}</td>
                    <td className="p-4 text-muted-foreground">{microsoft}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <section className="mt-12 rounded-xl border border-border bg-panel/50 p-6">
            ...
            <p className="mt-3 leading-7 text-muted-foreground">
              EleViewer supports DOCX, XLSX, PPTX, PDF, Markdown, CSV, HTML, and TXT. It also includes PDF Read Aloud, local course folders, session restore, and a built-in browser panel.
            </p>
            <a
              href={DOWNLOAD_URL}
              className="mt-6 inline-flex h-11 items-center justify-center rounded-lg bg-primary px-6 text-sm font-medium text-primary-foreground transition-opacity"
            >
              Download EleViewer
            </a>
          </section>
