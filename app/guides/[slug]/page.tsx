    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main id="main-content" className="flex-1">
        <article className="mx-auto max-w-4xl px-5 py-16 sm:py-24">
          ...
          <BreadcrumbJsonLd items={[{ name: "EleViewer", url: "https://eleviewer.vercel.app/" }, { name: "Guides", url: "https://eleviewer.vercel.app/guides" }, { name: guide.title, url: `https://eleviewer.vercel.app/guides/${slug}` }]} />
