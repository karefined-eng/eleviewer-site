    ...
    sections: [
      {
        ...
        notice: {
          ...
          message: "EleViewer distributes as a single ~129 MB portable Windows executable (.exe). No administrative privileges or Windows installers are required to run the application."
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Executable Size", "~129 MB One-file Portable Binary"],
