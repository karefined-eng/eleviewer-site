    ...
    sections: [
      {
        ...
        notice: {
          ...
          message: "EleViewer distributes as a single ~135 MB portable Windows executable (.exe). No administrative privileges or Windows installers are required to run the application."
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Executable Size", "~135 MB One-file Portable Binary"],
