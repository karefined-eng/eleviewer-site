  ...
  return (
    ...
    >
        ...
        <div className="min-w-0 flex-1 bg-[#1e1e1e] p-5 font-mono text-[12px] leading-relaxed select-text">
          ...
          {activeTabId === "pdf" && (
            <div className="animate-in fade-in duration-200 space-y-3">
              ...
              <div className={`rounded p-4 text-[#ddd] font-sans leading-normal shadow-inner transition-colors ${isPlaying ? 'bg-accent/10 border border-accent/30' : 'bg-[#2a2a2b]'}`}>
              ...
              {(isPlaying || isPaused) && (
                <div className="flex items-center gap-2 text-accent text-[11px] bg-[#252526] p-2 rounded border border-[#333] animate-in slide-in-from-bottom-2 fade-in">
      ...
      <div className="flex items-center justify-between border-t border-[#333] bg-[#1e1e1e] px-4 py-1.5 font-mono text-[10px] text-[#777]">
        ...
        <span className="hidden sm:inline">Try the Text-to-Speech (TTS) controls in the top right</span>
